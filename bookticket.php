<?php
  ...
  session_start();
	...
	if ($success === true){
		if($_POST['source'] && $_POST['type'] && $_POST['number'] && $_POST['destination'] && $_POST['class'] && $_POST['boarding_time']){
			$source = $_POST['source'];
			$type = $_POST['type'];
			...
			$sql = "INSERT INTO ticketbooking (uid, source, destination,  class, type, no_of_ticket, fare, boarding_time, booking_time, barcode) VALUES ('$uid', '$source', '$destination', '$class', '$type', '$number', '$amount', '$boardingtime', '$currentTimeDate', '$uniqueTicketNo')";
...
<head>
	...
	<title>MTTB || Ticket Confirmation</title>
...
<body>	
	...
	<div class="d-none" id="main">
		...
		<div class="container my-2">
			<a href="./login.php" class="btn btn-primary mt-3 d-inline-flex align-items-center justify-content-center">
