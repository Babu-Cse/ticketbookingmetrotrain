<?php
  ...
  session_start();
	...
	if ($success === true){
		if($_POST['source']  && $_POST['destination'] &&  $_POST['class'] &&	$_POST['duration']){
			...
			$sql1 = "INSERT INTO passbooking (uid, source, destination,  class, duration, valid_from, valid_to, fare, booking_time) VALUES ('$uid', '$source', '$destination', '$class', '$duration', '$valid_from', '$valid_to', '$amount', '$valid_from')";

			$conn->query($sql1);

			$sql = "INSERT INTO passgeneration (uid, ticket_no, source, destination, class, duration, valid_from, valid_to, fare, booking_time, barcode) VALUES ('$uid', '$uniqueTicketNo', '$source', '$destination', '$class', '$duration', '$valid_from', '$valid_to', '$amount', '$valid_from', '$uniqueTicketNo')";
...
<head>
	...
	<title>MTTB || Pass Confirmation</title>
...
<body>	
	...
	<div class="d-none" id="main">
		<nav id="navbar" class="navbar navbar-expand-lg navbar-dark">
			<div class="container">
				<a class="navbar-brand" href="login.php">Metro Train Ticket Booking</a>
			</div>
		</nav>
