<?php
   ...
   if(!isset($_SESSION['uidorPhone'])){
	...
	$data = [
		"key"               => $RazorpayKeyId,
		"amount"            => $amount,
		"name"              => "Metro Train Ticket Booking",
		"description"       => "Chennai Metro Train Ticket Booking site.",
      ...
      <section class="banner-area jumbotron position-relative" id="home">
         ...
         <div class="container">
            <div class="banner-content position-relative d-flex flex-column align-items-center justify-content-center">
               <h2 class="text-white display-4">Welcome to Metro Train Ticket Booking</h2>
               <p class="text-white mt-3 mb-5">
                  Quick MTTB Local Train Booking
               </p>
            </div>
         </div>
      </section>
            ...
            <div class="row d-flex justify-content-center">
               <div class="menu-content pb-60 col-lg-8">
                  <div class="title text-center">
                     <h2 class="mb-3">Why Choose MTTB to Book Local Tickets ?</h2>
                  </div>
               </div>
            </div>
            <div class="col-sm-6">
